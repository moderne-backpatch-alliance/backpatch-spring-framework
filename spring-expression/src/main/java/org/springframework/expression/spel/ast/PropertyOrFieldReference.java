...
public class PropertyOrFieldReference extends SpelNodeImpl {
	...
	public ValueRef getValueRef(ExpressionState state) throws EvaluationException {
		return new AccessorLValue(this, state.getActiveContextObject(), state, state.getEvaluationContext(),
				state.getConfiguration().isAutoGrowNullReferences());
	}

	@Override
	public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
		TypedValue tv = getValueInternal(state, state.getActiveContextObject(), state.getEvaluationContext(),
				state.getConfiguration().isAutoGrowNullReferences());
	...
	public TypedValue setValueInternal(ExpressionState state, Supplier<TypedValue> valueSupplier)
		...
		writeProperty(state, state.getActiveContextObject(), state.getEvaluationContext(), this.name,
				typedValue.getValue());
		return typedValue;
	}
	...
	private static class AccessorLValue implements ValueRef {
		...
		public TypedValue getValue() {
			TypedValue value = this.ref.getValueInternal(this.expressionState, this.contextObject,
					this.evalContext, this.autoGrowNullReferences);
